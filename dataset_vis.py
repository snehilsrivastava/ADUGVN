...
if __name__ == '__main__':
    train_image_path = '/content/PAAD-MAIN/train_set/images_train'
    train_csv_path   = '/content/PAAD-MAIN/train_set/labeled_data_train.csv'
    test_image_path  = '/content/PAAD-MAIN/test_set/images_test'
    test_csv_path    = '/content/PAAD-MAIN/test_set/labeled_data_test.csv'
